  ...
  module Hooks
    ...
    class Hook
      ...
      HOOKS = [
        ...
        # See: SavonZuora::SOAP::Request#response
        #
        # Arguments
        #
        #   [callback] A block to execute the SOAP request
        #   [request]  The current <tt>SavonZuora::SOAP::Request</tt>
        #
        # Examples
        #
        #   Log the time before and after the SOAP call:
        #
        #     SavonZuora.config.hooks.define(:my_hook, :soap_request) do |callback, request|
        ...
        #
        #     SavonZuora.config.hooks.define(:mock_hook, :soap_request) do |_, request|
