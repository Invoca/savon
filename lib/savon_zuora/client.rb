...
require "savon_zuora/wasabi/document"
require "savon_zuora/soap/xml"
require "savon_zuora/soap/request"
...
module SavonZuora
  ...
  # = SavonZuora::Client
  #
  # SavonZuora::Client is the main object for connecting to a SOAP service.
  class Client

    # Initializes the SavonZuora::Client for a SOAP service. Accepts a +block+ which is evaluated in the
    ...
    #
    #   # Using a local WSDL
    #   client = SavonZuora::Client.new File.expand_path("../wsdl/service.xml", __FILE__)
    #
    ...
    # Returns the <tt>SavonZuora::Wasabi::Document</tt>.
    def wsdl
    ...
    # Returns the <tt>SavonZuora::SOAP::XML</tt> object. Please notice, that this object is only available
    # in a block given to <tt>SavonZuora::Client#request</tt>. A new instance of this object is created
    # per SOAP request.
    attr_reader :soap
    ...
    def request(*args, &block)
      raise ArgumentError, "SavonZuora::Client#request requires at least one argument" if args.empty?
  ...
  private
    ...
    # Writer for the <tt>SavonZuora::SOAP::XML</tt> object.
    attr_writer :soap
