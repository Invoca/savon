module SavonZuora
  module SOAP
    ...
    # = SavonZuora::SOAP::RequestBuilder
    #
    # SavonZuora::SOAP::RequestBuilder builds SavonZuora::SOAP::Request instances.
    ...
    class RequestBuilder
      ...
      # Writer for the <tt>SavonZuora::Config</tt> object.
      attr_writer :config

      # Writer for the attributes of the SOAP input tag. Accepts a Hash.
      attr_writer :attributes

      # Writer for the namespace identifer of the <tt>SavonZuora::SOAP::XML</tt>
      # object.
      attr_writer :namespace_identifier

      # Writer for the SOAP action of the <tt>SavonZuora::SOAP::XML</tt> object.
      attr_writer :soap_action

      # Reader for the operation of the request being built by the request builder.
      attr_reader :operation

      # Builds and returns a <tt>SavonZuora::SOAP::Request</tt> object. You may optionally
      ...
      # Returns the <tt>SavonZuora::Config</tt> object for the request. Defaults
      # to a clone of <tt>SavonZuora.config</tt>.
      def config
        @config ||= SavonZuora.config.clone
      end
