...
describe SavonZuora::HTTP::Error do
  let(:http_error) { SavonZuora::HTTP::Error.new new_response(:code => 404, :body => "Not Found") }
  let(:no_error) { SavonZuora::HTTP::Error.new new_response }

  it "should be a SavonZuora::Error" do
    SavonZuora::HTTP::Error.should < SavonZuora::Error
  end
