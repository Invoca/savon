...
describe SavonZuora::SOAP::RequestBuilder do
  describe "#request" do
    def build_request_builder(operation)
      request_builder = SavonZuora::SOAP::RequestBuilder.new(operation)
    ...
    before do
      SavonZuora::SOAP::Request.stubs(:new).returns(stub_everything('request'))
    end
