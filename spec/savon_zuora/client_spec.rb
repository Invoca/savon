...
describe SavonZuora::Client do
  ...
  describe ".new" do
    ...
    context "with a block expecting one argument" do
      it "should yield the WSDL object" do
        SavonZuora::Client.new { |wsdl| wsdl.should be_a(SavonZuora::Wasabi::Document) }
      end
    end
    ...
    context "with a block expecting two arguments" do
      it "should yield the WSDL and HTTP objects" do
        SavonZuora::Client.new do |wsdl, http|
          wsdl.should be_an(SavonZuora::Wasabi::Document)
    ...
    context "with a block expecting no arguments" do
      it "should let you access the WSDL object" do
        SavonZuora::Client.new { wsdl.should be_a(SavonZuora::Wasabi::Document) }
      end
  ...
  describe "#wsdl" do
    it "should return the SavonZuora::Wasabi::Document" do
      client.wsdl.should be_a(SavonZuora::Wasabi::Document)
    end
  end
  ...
  describe "#request" do
    ...
    context "with a block expecting four arguments" do
      it "should yield the SOAP, WSDL, HTTP and WSSE objects" do
        client.request(:authenticate) do |soap, wsdl, http, wsse|
          soap.should be_a(SavonZuora::SOAP::XML)
          wsdl.should be_a(SavonZuora::Wasabi::Document)
          http.should be_an(HTTPI::Request)
    ...
    context "with a block expecting no arguments" do
      ...
      it "should let you access the WSDL object" do
        client.request(:authenticate) { wsdl.should be_a(SavonZuora::Wasabi::Document) }
      end
    end
