...
describe "Temperature example" do
  ...
  it "converts 30 degrees celsius to 86 degrees fahrenheit" do
    client = SavonInvoca.client do
      ...
      # Needed because (up until now), SavonInvoca doesn't match XS types to Hash keys,
      # but defaults to convert Hash message Symbols (like :from_unit) to lowerCamelCase.
      # The service expects these to be CamelCase instead. Look at SavonInvoca's log output
